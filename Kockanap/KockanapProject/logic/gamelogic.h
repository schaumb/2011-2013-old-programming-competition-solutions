...
private:
    ...
    void felfedezes()
    {
       ...
       // qDebug() << hajo_mi.size();
        ...
        qDebug() << "Ennyi bolygonk van "  << bolygo_mi.size();
        qDebug() << "Felderítők: " << felfedezok;
        qDebug() << "Talált bolygó: " << uresBolygok.size();
    ...
    void tamadas_nem()
    {
        qDebug() << "Támadás üres bolygot állapot" ;
        /*
        std::set<UL> uresBolygok;
    ...
    void tamadas()
    {
        qDebug() << "Állapot: Támadás ellenfél";
